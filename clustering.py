...
#rom Matrice_Note_V2 import M_note, M_id
# #regarder je ne pense pas que je puisse importer des matrice au pire tester avec des fausses aux debut
X = np.array([[1, 1], [2, 1], [3, 1.2], [4, 1], [5, 0.8], [6, 1]])
#dans notre matrice cela corresponds aux films (dans la matrice films user)
